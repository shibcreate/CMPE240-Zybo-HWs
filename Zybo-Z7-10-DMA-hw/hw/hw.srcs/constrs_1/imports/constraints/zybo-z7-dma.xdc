...
##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports {btns_4bits_tri_i[0]}]; #IO_L12N_T1_MRCC_35 Sch=BTN0
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports {btns_4bits_tri_i[1]}]; #IO_L24N_T3_34 Sch=BTN1
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports {btns_4bits_tri_i[2]}]; #IO_L10P_T1_AD11P_35 Sch=BTN2
