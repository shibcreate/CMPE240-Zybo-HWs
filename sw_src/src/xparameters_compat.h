...
/* ---- Interrupt IDs ----
 * SDT generates XPAR_FABRIC_*_INTR as SPI offsets (e.g. 29 for IRQ_F2P[0]).
 * XScuGic_Connect on Zynq-7000 expects the full GIC ID (e.g. 61).
 * Add XSCUGIC_SPI_INT_ID_START (=32) to convert.
 */
#include "xscugic.h"
...
/* Note: in this BD, the concat order is mm2s -> In2 (INTR=31), s2mm -> In3 (INTR_1=32). */
